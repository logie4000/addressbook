class Person < ApplicationRecord
  ...
  accepts_nested_attributes_for :children, :allow_destroy => true, reject_if: proc {|attributes| attributes[:firstName].blank? || attributes[:firstName] == Person.child_placeholder_value }
